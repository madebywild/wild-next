...
Visit our [server setup guide](/server-setup/6) to setup a live site. Note: this guide is private.
...
This boilerplate uses [TailwindCSS](https://tailwindcss.com/) and [styled-components](https://styled-components.com/docs) using the [twin.macro](https://github.com/ben-rogerson/twin.macro/#features) plugin.
...
If you need to programmatically check the active media query, you can use the hook in `~/hooks/use-media-query`.
