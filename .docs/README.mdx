...
<Code language="json">{JSON.stringify(scripts, null, 4)}</Code>
...
The [wild-next](https://github.com/madebywild/wild-next) boilerplate uses [TailwindCSS](https://tailwindcss.com/) and [styled-components](https://styled-components.com/docs) using the [twin.macro](https://github.com/ben-rogerson/twin.macro/#features) plugin.
